          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              {[
                ...
                <div key={vis.name} className={`bg-${vis.color}-900/20 p-3 rounded-md border border-${vis.color}-500/30`}>
              ...
              {[
                ...
                <div key={channel.name} className="bg-card/50 p-3 rounded-md border border-border">
                  <div className="flex justify-between items-center">
                    ...
                    <div className={`text-xs px-2 py-0.5 rounded bg-${channel.color}-500/20 text-${channel.color}-400`}>
                      {channel.status}
                    </div>
                  </div>
